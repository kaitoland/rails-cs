...
class RespondsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create respond" do
    assert_difference('Respond.count') do
      post responds_url, params: { respond: { contact_id: @respond.contact_id, deal: @respond.deal, point: @respond.point, respond_date: @respond.respond_date, staff: @respond.staff, title: @respond.title, wording: @respond.wording } }
    end
  ...
  test "should update respond" do
    patch respond_url(@respond), params: { respond: { contact_id: @respond.contact_id, deal: @respond.deal, point: @respond.point, respond_date: @respond.respond_date, staff: @respond.staff, title: @respond.title, wording: @respond.wording } }
